...
d.data("hover",false);d.find("div#popup").hide();return a.m.settings.type="focus";},destroyFocus:function(){d.find("div#tippop_focus").each(function(){return $.removeData($(this).data);
...
return{g_top:f,g_bottom:g};},getTipPop:function(){var f;f=$("body").find("div#popup");if(f.length===0){$("body").append('<div id="popup"></div>');f=$("div#popup");
